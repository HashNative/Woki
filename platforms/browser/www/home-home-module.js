...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.startSearch = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.circle) {
                    this.circle.remove();
    ...
    HomePage.prototype.search = function () {
        ...
        this.http.get('https://www.hashnative.com/alloffers', {}, {})
            ...
            for (var j = 0; j < _this.offers.length; j++) {
                ...
                if (_this.searchEnable === true && _this.calculateDistance(location.split(',')[0], location.split(',')[0]) < radius) {
                    _this.presentNotification('An offer available near you.', name, offer_item, offer_price);
                    console.log('success');
                }
                _this.presentToast(location.split(',')[0]);
            }
        })
